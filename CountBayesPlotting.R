...
#answer:  I get an error when I use the summary functions below and I cant seem to figure out why.  
# I ran model 2 since there did not seem to be an abundance of zeros in the data and there is likely some variation between site locations.  
...
colnames(alpha.mat) <- c("Time of Day", "Time of Day Squared")
...
# unmarked analysis?
# Answer:  This plot shows relative abundance over time whereas the plot from CountAnalysis shows Probability of Occupancy by Time of Day.  
# 
...
######## How does this plot compare to the one you obtained from the 
# unmarked analysis?
# Answer: This plot shows Probability of Detection by Time of Day (minutes past 6am).  The plot from CountAnalysis shows Probability of Occupancy by Time of Day.  The curves look identical.  The probability of occupancy and the probability of detection follow the same path across times of day.
# 
