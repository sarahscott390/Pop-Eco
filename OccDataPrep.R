...
## Survey 1 had 20 detections, survey 2 had 10, and survey 3 had 14.
...
###looking at range, outliers .. 

# What do you note? Any apparent issues with these data?
# Answer:  The cheatgrass data appears to be normally distributed, the sagebrush data is heavily weighted to the left side with more low values than high values.  Temperature data is less normal looking and harder to interpret.  Feb minimum temp has a pretty dramatic outlier and has an odd shape overall.  Apr/May max temp is very spaced out throughout.
...
# Any notable sites? 
### Answer: Site 3 consistently has more sagebrush than other sites.  Site 78 had a dramatic increase in cheatgrass around 2014.
#Overall, there was a notable peak in 2010 followed by steep decline in temperature than seems to have resulted in a similar pattern for the vegetation.  Sagebrush seems to have experienced a steeper decline than cheatgrass.  Cheatgrass peaked around that time but then only dipped a small amount before continuing on an upward trend.
...
## some positive correlation between Feb.minT and AprMay.maxT, this seems intuitive to me, since they are the two weather variables and I would assume weather conditions are correlated within seasons to a certain degree.  
